...
export const GraphSettings = z.object({
  ...
  tags: z.string().default(''),
  checkpointer: CheckpointerSettings.prefault({}),
  server: ServerSettings.prefault({}),
  model: ModelSettings.prefault({}),
  observability: ObservabilitySettings.prefault({}),
  logging: LoggingSettings.prefault({}),
  security: SecuritySettings.prefault({}),
  deployment: DeploymentSettings.prefault({}),
  lifecycle: z
...
export const Logical = z.object({
  ...
  settings: GraphSettings.prefault({}),
